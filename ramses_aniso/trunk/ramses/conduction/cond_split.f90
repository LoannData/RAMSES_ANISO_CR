...
! ----------------------------------------------------------------
subroutine cond_split(uin,flux,dx,dy,dz,dt,ngrid,compute,fdx,itemp)
  use amr_parameters
  use const             
  ...
  real(dp)::scale_n,fudge_mfp

  real(dp)::n_e,flux_sat,scale_jsat
  real(dp),dimension(1:nvector,iu1:iu2,ju1:ju2,ku1:ku2)::jsat
  integer ::ind_Teold
...
subroutine cmpXheatflx(Temp,dens,bf,kspitzer,myflux,dx,dy,dz,dt,ngrid,compute,ffdx,Temp2)
  ...
  real(dp)::dmean,dmean1,dmean2,dmean3,dmean4
  real(dp)::Tmean,Tmean1,Tmean2,Tmean3,Tmean4
  real(dp)::dTolddx,dTolddx1,dTolddx2,dTolddx3,dTolddx4
  real(dp)::dTolddy,dTolddy1,dTolddy2,dTolddy3,dTolddy4
  real(dp)::dTolddz,dTolddz1,dTolddz2,dTolddz3,dTolddz4
  real(dp)::l_t,l_t1,l_t2,l_t3,l_t4
  real(dp)::mfp_e,mfp_e1,mfp_e2,mfp_e3,mfp_e4
  real(dp)::sat_coef,sat_coef1,sat_coef2,sat_coef3,sat_coef4
  real(dp)::ratio,ratio1,ratio2,ratio3,ratio4,fudge_mfp
