subroutine read_hydro_params(nml_ok)
  ...
  namelist/physics_params/cooling,haardt_madau,metal,isothermal &
       ...
       & ,conduction,twotemp,isotrope_cond,slopelim_cond,k_perp,f_spitzer,cr_diffusion,alfven_diff_coeff &
       & ,M0,r_length,testcase,fix_temp_diff,Dcr,flinj,saturation,coupling,epsilon_diff,coupling_out_of_conduction
