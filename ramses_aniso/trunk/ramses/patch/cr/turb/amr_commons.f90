module amr_commons
  ...
  real(dp)::eturb_tot=0.0D0                     ! Total added turbulent energy 
  real(dp)::eturb_ever=0.0D0                    ! Cumulative turbulent energy
  ...
  real(dp)::old_t=0.0D0                         ! Old time (if using reset_time)
  real(dp)::maxrho=0.0D0                        ! Maximum density         
