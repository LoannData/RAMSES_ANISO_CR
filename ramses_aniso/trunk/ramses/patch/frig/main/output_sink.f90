...
subroutine output_sink(filename)
  ...
  write(ilun,'(" ================================================================================================================================== ")')
  write(ilun,'("        Id        Mass(Msol)       dMass(Msol)          x                y                z               vx               vy               vz       Nphot   ")')
  write(ilun,'(" ================================================================================================================================== ")')
  ...
  do isink=1,nsink
     ...
     write(ilun,'(I10,9(2X,E15.7))')idsink(isink),msink(isink)*scale_m/2d33,dmfsink(isink)*scale_m/2d33,xsink(isink,1:ndim),vsink(isink,1:ndim),Eioni(isink)
  end do
  write(ilun,'(" ================================================================================================================================== ")')
  close(ilun)
...
subroutine output_sink_csv(filename)
  ...
  !======================
  do isink=1,nsink
     write(ilun,'(I10,13(A1,ES20.10))')idsink(isink),',',msink(isink),&
